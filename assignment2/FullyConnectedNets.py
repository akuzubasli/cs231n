...
model = TwoLayerNet(hidden_dim = 500, reg = 0.6)
solver = None
...
solver = Solver(model, data, update_rule='sgd',
                ...
                lr_decay=0.95,num_epochs=12,batch_size=200,print_every=100)
...
# 
# # Answer:
# Five layer was easier to train.
# 
...
# # SGD+Momentum
# Stochastic gradient descent with momentum is a widely used update rule that tends to 
#make deep networks converge faster than vanilla stochstic gradient descent.
# 
...
#run the following to check your implementation. You should see errors less than 1e-8.
...
# Once you have debugged your RMSProp and Adam implementations, 
#run the following to train a pair of deep networks using these new update rules:
...
# but we don't require it for this part and won't assign extra credit for doing so. 
# Later in the assignment we will ask you to train the best convolutional network 
# that you can on CIFAR-10, and we would prefer that you spend your effort working 
# on convolutional nets rather than fully-connected nets.
# 
# You might find it useful to complete the `BatchNormalization.ipynb` and `Dropout.ipynb` 
    ...
    for reg in regularization_strengths:
      for p in dropout:
        for lr in learning_rates:
          print("learning rate: %2.e // reg: %.2f // p: %.2f" % (lr, reg, p))
