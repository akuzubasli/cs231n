...
# 
# You don't have to worry too much about efficiency at this point; 
...
#  the type of operation that convolutional layers can perform, 
#  we will set up an input containing two images and manually set up filters 
#  that perform common image processing operations (grayscale conversion and edge detection). 
