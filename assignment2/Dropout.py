...
#  Specificially, if the constructor the the net receives a nonzero value for the `dropout` parameter, 
#  then the net should add dropout immediately after every ReLU nonlinearity. 
